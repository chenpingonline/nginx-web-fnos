...
<template><form class="form-grid" @submit.prevent="emit('save',{...form})">
  ...
  <div class="field full"><label for="private-key">私钥（PEM）</label><textarea id="private-key" v-model="form.private_key" class="textarea" required rows="8" spellcheck="false" placeholder="-----BEGIN PRIVATE KEY-----"></textarea><span class="field-help">私钥只发送给本机 nginx-web，并以 0600 权限保存。</span></div>
