...
const acme = ref<ACMEInput>({name:"",ca:"letsencrypt",directory_url:"",email:"",domains:[],provider:"alidns",key_type:"rsa2048",rotate_key:true,accept_terms:false,propagation_seconds:180,credentials:{token:"",access_id:"",secret:"",eab_kid:"",eab_hmac:""}});
